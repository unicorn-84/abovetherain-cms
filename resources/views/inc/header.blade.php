      ...
      <div id='navbarSupportedContent' class="collapse navbar-collapse">
        <ul class="navbar-nav ml-auto text-uppercase">
          <li class="{{ Request::is('services') ? 'active ' : '' }}nav-item px-lg-3">
            <a href="{{ url('services') }}" class="nav-link py-lg-1 px-lg-0">Услуги</a>
          </li>
          <li class="{{ Request::is('schedule') ? 'active ' : '' }}nav-item px-lg-3">
            <a href="{{ url('schedule') }}" class="nav-link py-lg-1 px-lg-0">Расписание</a>
          </li>
          <li class="{{ Request::is('events') ? 'active ' : '' }}nav-item px-lg-3">
            <a href="{{ url('events') }}" class="nav-link py-lg-1 px-lg-0">Афиша</a>
          </li>
          <li class="{{ Request::is('team') ? 'active ' : '' }}nav-item px-lg-3">
            <a href="{{ url('team') }}" class="nav-link py-lg-1 px-lg-0">Мы</a>
          </li>
          <li class="{{ Request::is('coaches') ? 'active ' : '' }}nav-item px-lg-3">
            <a href="{{ url('coaches') }}" class="nav-link py-lg-1 px-lg-0">Тренеры</a>
          </li>
          <li class="{{ Request::is('gallery') ? 'active ' : '' }}nav-item px-lg-3">
            <a href="{{ url('gallery') }}" class="nav-link py-lg-1 px-lg-0">Галерея</a>
          </li>
          <li class="{{ Request::is('contacts') ? 'active ' : '' }}nav-item px-lg-3">
            <a href="{{ url('contacts') }}" class="nav-link py-lg-1 px-lg-0">Контакты</a>
          </li>
        </ul>
      </div>
    </div>
