  ...
  <div class="py-5">
    <div class="container">
      <div class="d-flex flex-column flex-lg-row justify-content-center align-items-center">
        ...
        @if(Voyager::setting("content.vk") || Voyager::setting("content.instagram") || Voyager::setting("content.facebook"))
          <div class="d-flex justify-content-center w-100 mb-4 mb-lg-0">
            @if(Voyager::setting("content.vk"))
              <a href="{{ Voyager::setting("content.vk") }}" class="mx-3 text-decoration-none text-reset"
                 title="VKontakte">
                <i class="fab fa-vk fa-2x"></i>
              </a>
            @endif
            @if(Voyager::setting("content.instagram"))
              <a href="{{ Voyager::setting("content.instagram") }}" class="mx-3 text-decoration-none text-reset"
                 title="Instagram">
                <i class="fab fa-instagram fa-2x"></i>
              </a>
            @endif
            @if(Voyager::setting("content.facebook"))
              <a href="{{ Voyager::setting("content.facebook") }}" class="mx-3 text-decoration-none text-reset"
                 title="Facebook">
        ...
        <div class="d-flex justify-content-center w-100 order-lg-first">
          <a href="{{ route('requisites') }}" class="text-reset" title="Реквизиты для оплаты ">Реквизиты</a>
        </div>
      </div>
    </div>
  </div>
  @if(Voyager::setting("site.title"))
