...
@section('content')
    <div style="background-size:cover; background: center center url({{ Voyager::image( Voyager::setting('admin.bg_image')) }}); position:absolute; top:0; left:0; width:100%; height:300px;"></div>
