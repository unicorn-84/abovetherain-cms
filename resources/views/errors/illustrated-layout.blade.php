...
<head>
  ...
  <!--TITLE-->
  <title>@if(Voyager::setting('site.title')) {{ Voyager::setting('site.title') . ' | ' }}@endif @yield('title')</title>
...
<div class="md:flex min-h-screen">
  <div class="w-full md:w-1/2 bg-white flex items-center justify-center">
    <div class="max-w-sm m-8">
      ...
      <div class="w-16 h-1 bg-caribbean_green-light my-3 md:my-6"></div>
